 ...
 *                                                                           *
 *   $Revision: 743 $                                                         *
 *   $Date: 2012-10-08 15:25:36 +0200 (Mo, 08 Okt 2012) $                   *
 *                                                                           *
\*===========================================================================*/
...
bool _OMReader_::read_binary_vertex_chunk(std::istream &_is, BaseImporter &_bi, Options &_opt, bool _swap) const
{
  ...
  switch (chunk_header_.type_) {
    case Chunk::Type_Pos:
      assert( OMFormat::dimensions(chunk_header_) == size_t(Vec3f::dim()));
    ...
    case Chunk::Type_Texcoord:
      assert( OMFormat::dimensions(chunk_header_) == size_t(Vec2f::dim()));
